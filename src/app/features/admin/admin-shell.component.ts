...
@Component({
  ...
  template: `
    <div class="admin-layout">
      <aside class="sidebar">
        <div class="sidebar-logo"><span>⚙️</span><span>Admin Panel</span></div>
        ...
        <div class="sidebar-footer">
          <a routerLink="/home" class="nav-item">
            <i class="pi pi-arrow-left"></i><span>Volver al sitio</span>
          </a>
        </div>
      </aside>
  ...
  styles: [`
    ...
    .sidebar { width: 220px; background: #1e293b; color: #e2e8f0; display: flex; flex-direction: column; flex-shrink: 0; position: fixed; top: 0; left: 0; bottom: 0; z-index: 50; }
    .sidebar-logo { padding: 20px 16px; font-size: 15px; font-weight: 600; border-bottom: 1px solid #334155; display: flex; align-items: center; gap: 8px; }
    .sidebar-nav { flex: 1; padding: 12px 8px; display: flex; flex-direction: column; gap: 2px; overflow-y: auto; }
    .nav-item { display: flex; align-items: center; gap: 10px; padding: 9px 12px; border-radius: 8px; text-decoration: none; color: #94a3b8; font-size: 14px; transition: all .15s; }
